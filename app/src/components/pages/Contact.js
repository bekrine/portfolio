      ...
      <div className="ct-content">
        ...
        <div className="css-content">
          ...
          <p className="css-line">
            email:{" "}
            <span className="css-value"> mohamed.bekrine.mb@gmail.com</span>
            <span className="bracket">;</span>
          </p>
          ...
          stackoverflow:{" "}
            <span className="css-value">
              <a
                href="https://stackoverflow.com/users/mine"
                target="__blank"
              >
               https://stackoverflow.com/users/mine
              </a>
            </span>
            <span className="bracket">;</span>
          </p> */}
